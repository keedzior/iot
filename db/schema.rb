...
ActiveRecord::Schema.define(version: 20150119011223) do
  ...
  create_table "admin_users", force: :cascade do |t|
    ...
    t.datetime "last_login",                  default: '2015-01-16 14:23:26'
  end
  ...
  create_table "configurations", force: :cascade do |t|
    ...
    t.string   "parameter_type", limit: 255
    t.binary   "binary_value",   limit: 65535
  ...
  create_table "sensors", force: :cascade do |t|
    t.string   "sensorName",       limit: 255
    t.string   "sensorValue",      limit: 255
    t.datetime "measurement_time"
    t.float    "floatValue",       limit: 24
  end
